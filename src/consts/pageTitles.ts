export const fixedTitle: string = 'La Velada del Año V Web Oficial - Evento de boxeo de Ibai Llanos con creadores de contenido'

export const porra: string = `La Porra - ${fixedTitle}`

export const pronosticos: string = `Pronósticos - ${fixedTitle}`
